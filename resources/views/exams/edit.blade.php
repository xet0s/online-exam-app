            ...
            <form action="{{ route('exams.update', $exam->id) }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input id="date" name="date" type="date" required value="{{ old('date', $exam->start_time->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input id="start_hour" name="start_hour" type="time" required value="{{ old('start_hour', $exam->start_time->format('H:i')) }}"
                    ...
                    <div>
                        ...
                        <input id="end_hour" name="end_hour" type="time" required value="{{ old('end_hour', $exam->end_time->format('H:i')) }}"
