@extends('layouts.app', ['title' => 'Bölüm Düzenle - Sınav Dağıtım'])
...
<div class="max-w-2xl mx-auto">
    <div class="relative z-10">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 mt-2">Bölümü Düzenle</h1>
            <p class="text-sm text-slate-500 mt-1">{{ $department->name }} bölümünün bilgilerini güncelleyin.</p>
        </div>
